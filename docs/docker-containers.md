...
flowchart BT
    ...
    style L1 fill:#325083,color:#ffffff
    style L2 fill:#c60158,color:#ffffff
    style L3 fill:#0d9488,color:#fffffffff
    style L4 fill:#92400e,color:#ffffff
    style L5 fill:#065f46,color:#ffffff
```
